...
'''
Insert all the num in a trie with bit values in respective position. So every node can have 2 children. 
...
While again traversing the num if the current bit of num is 1 then we try to move the cur 
pointer towards the child with 0 key.
